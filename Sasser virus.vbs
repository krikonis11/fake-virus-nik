X = MsgBox("Error. Do you want to fix it?",4+64,"Error")
...
X = MsgBox("Your PC is attacked with Sasser. Sending Data...",2+64,"Sasser")


X = MsgBox("Your Computer is Hacked!!!",1+64,"Sasser")
